...
<html>
    ...
    <?php
        ...
        else
        {
            ...
            $result=mysqli_query($link,"select * from $tablename WHERE type='staff'");
            ...
            if($trans===0)
            {
                mysqli_free_result($result);
                mysqli_close($link);
                echo "こちらのユーザ名またはパスワードは間違っているまたは図書館スタッフのものではないと考えられます";
                echo <<<EOT
